...
Usage:
    store_conversation.py "User message" "AI response" --date 2008-12-19 --tags "workflow"
...
def main():
    ...
    if args.file:
        ...
        for conv in conversations:
            user_point_id, ai_id = store_conversation_pair(
                conv["user"],
                conv["ai"],
                args.date,
        ...
        if user_point_id and ai_id:
            ...
            print(f"   User turn: {user_point_id[:8]}...")
