...
Features:
- Persistent user_id (e.g., "yourname") across all conversations
...
Mem0 Architecture:
    - user_id: "yourname" (persistent across all your chats)
...
def store_conversation_turn(
    ...
    Args:
        user_id: PERSISTENT user identifier (e.g., "yourname") - REQUIRED
    ...
    # Store AI response
    ai_text = f"[{os.getenv('AGENT_NAME', 'Assistant')}]: {ai_response}"
...
def main():
    ...
    parser.add_argument("--user-id", required=True, 
                        help="REQUIRED: Persistent user ID (e.g., 'yourname')")
