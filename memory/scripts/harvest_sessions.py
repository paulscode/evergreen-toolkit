...
Usage: python3 harvest_sessions.py [--user-id yourname] [--dry-run]
"""
...
def store_turn(user_id: str, user_msg: str, ai_response: str, 
    ...
    ai_embedding = get_embedding(f"[{os.getenv('AGENT_NAME', 'Assistant')}]: {ai_response}")
    ...
    points.append({
        ...
        "payload": {
            "user_id": user_id,
            "text": f"[{os.getenv('AGENT_NAME', 'Assistant')}]: {ai_response[:2000]}",
            "date": date_str,
