...
Usage:
    extract_facts.py [--date 2008-12-19] [--dry-run] [--batch-size 50]
...
OLLAMA_EMBED_URL = os.getenv("OLLAMA_URL", "http://127.0.0.1:11434/v1")
MEMORY_DIR = Path(os.getenv("OPENCLAW_WORKSPACE", str(Path.home() / ".openclaw" / "workspace"))) / "memory"
...
def main():
    ...
    parser.add_argument("--user-id", help="User ID for per-user memory directory")
